...
proc create_root_design { parentCell } {
    ...
    # Create instance: txpippm_cont_0, and set properties
    set txpippm_cont_0 [ create_bd_cell -type module -reference txpippm_controllers_regs txpippm_cont_0 ]
    ...
    connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins txpippm_cont_0/s_axi] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
    connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins mdm_1/MBDEBUG_0] [get_bd_intf_pins microblaze_0/DEBUG]
    connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
    connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]

    # Create port connections
    connect_bd_net -net txpippm_cont_0_pulse_pulse [get_bd_pins txpippm_cont_0/pulse_pulse] [get_bd_pins microblaze_0_gth_transceivers_buffer/pulse_in] [get_bd_pins vio_0/probe_in2]
    connect_bd_net -net txpippm_cont_0_reset_reset [get_bd_pins txpippm_cont_0/reset_reset] [get_bd_pins microblaze_0_gth_transceivers_buffer/hb_gtwiz_reset_all_in] [get_bd_pins vio_0/probe_in0]
    connect_bd_net -net txpippm_cont_0_sel_sel [get_bd_pins txpippm_cont_0/sel_sel] [get_bd_pins microblaze_0_gth_transceivers_buffer/sel_in] [get_bd_pins vio_0/probe_in1]
    connect_bd_net -net txpippm_cont_0_stepsize_stepsize [get_bd_pins txpippm_cont_0/stepsize_stepsize] [get_bd_pins microblaze_0_gth_transceivers_buffer/stepsize_in] [get_bd_pins vio_0/probe_in3]
    ...
    connect_bd_net -net microblaze_0_Clk [get_bd_pins txpippm_cont_0/axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_gth_transceivers_buffer/hb_gtwiz_reset_clk_freerun_in] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins vio_0/clk]
    ...
    connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins txpippm_cont_0/axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]

    # Create address segments
    create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs txpippm_cont_0/s_axi/reg0] SEG_txpippm_cont_0_reg0
